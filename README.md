...
| :--- | :--- | :---: |
| [**herdr-agent-usage**](https://github.com/levi-qiao/herdr-agent-usage) | Credential-scoped AI usage, context, and cache in Herdr for Claude, Codex, Grok, Agy, OpenCode, Pi, omp, Devin, Muse, and Cursor. | 132 |
