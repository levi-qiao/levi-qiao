...
| [**herdr-agent-quota**](https://github.com/levi-qiao/herdr-agent-quota) | Credential-scoped AI quota, context, and cache in Herdr for Claude, Codex, Grok, Agy, OpenCode, Pi, and OMP. | 52 |
